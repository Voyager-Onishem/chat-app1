...
// Form component props (basic interfaces)
...
export interface BasicFormControlProps extends BasicFormFieldProps {
  name: string;
  value?: string;
  onChange?: ChangeHandler;
}

export interface BasicButtonProps extends BaseProps {
